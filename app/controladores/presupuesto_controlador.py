...
async def listar_todos(sesion: AsyncSession = Depends(obtener_sesion)):
    """Todos los presupuestos del taller (vista general)."""
    return await ServicioPresupuesto.listar_todos(sesion)
