...
@router.get("/ordenes")
async def listar_todas(estado: str | None = None, sesion: AsyncSession = Depends(obtener_sesion)):
    """Todas las órdenes del taller (vista general). Filtra por ?estado=pendiente|finalizada|cobrada."""
    return await ServicioOrden.listar_todos(sesion, estado)
